...
<div style="background-color:#002060; padding:20px; border-radius:12px; text-align:center; box-shadow: 2px 4px 12px rgba(0,0,0,0.25);">
    <h1 style="color:#FFFFFF !important; font-family:'Georgia', serif; margin:0; font-size: 32px; font-weight: bold;">
        ॐ తెలుగు పంచాంగం కన్వర్టర్ ॐ
    </h1>
    <p style="color:#FF9933 !important; font-size:16px; margin:8px 0 0 0; letter-spacing: 1px; font-weight: bold;">
